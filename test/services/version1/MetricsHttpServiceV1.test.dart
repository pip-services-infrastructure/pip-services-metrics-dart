...
//       await rest.post(url + '/v1/metrics/update_metric',
...
//       var responce = await rest.post('/v1/metrics/get_metrics_by_filter',
//           headers: {'Content-Type': 'application/json'},
//           body: json.encode({
...
//     //             var updateMetrics = Array<MetricUpdateV1>();
...
//     //                 expect.empty(definition.dimension3);
//     //                 callback();
